  ...
  <div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Blank template</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                          ...
                          if( $password == $repassword )
                          {
                            ...
                            if(!empty($image)){
                              ...
                              if( in_array($img_extension, $def_extens) === true && $imageSize <= 2097152){
                                ...
                                $sql = "INSERT INTO users (name, email, password, phone, address, role, status, image, join_date) VALUES('$name', '$email', '$haspassed', '$phone', '$address', '$role', '$status', '$img', now())";
                              ...
                              $sql = "INSERT INTO users (name, email, password, phone, address, role, status, join_date) VALUES('$name', '$email', '$haspassed', '$phone', '$address', '$role', '$status', now())";
                              $addUser = mysqli_query($db, $sql);
